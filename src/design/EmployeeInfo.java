...
import java.util.Scanner;
    ...
    public class EmployeeInfo extends AbstractClass implements Employee {
        ...
        public void NestedMethod(){
            System.out.println("this is my Nested Method");
        }
        ...
        public EmployeeInfo(String name, int employeeId) {
            ...
            System.out.println("name, employeeId" + employeeId + " " + name);
        }
        ...
        public static double calculateEmployeePension() {
          ...
          /*  Scanner sc = new Scanner(System.in);
            ...
            */
            ...
            double pension=total;
            int StartingDate=2017;
            int CurrentDate=2018;

            if (CurrentDate-StartingDate<=1){
                pension = salary * .05;
                System.out.println("employee pension is "+pension);
